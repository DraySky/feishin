...
const ItemTableListPropsSchema = z.object({
    ...
    size: z.enum(['compact', 'medium', 'default', 'large']),
});
        ...
        ['albumDetail']: {
            ...
            table: {
                ...
                columns: pickTableColumns({
                    ...
                    columnWidths: {
                        [TableColumn.DURATION]: 150,
                        [TableColumn.PLAY_COUNT]: 339,
                        [TableColumn.TITLE]: 400,
                        [TableColumn.TRACK_NUMBER]: 18,
                        [TableColumn.USER_FAVORITE]: 52,
                    },
                    enabledColumns: [
                        TableColumn.TRACK_NUMBER,
                        TableColumn.TITLE_ARTIST,
        ...
        ['sideQueue']: {
            ...
            table: {
                ...
                columns: pickTableColumns({
                    ...
                    columns: SONG_TABLE_COLUMNS,
                    enabledColumns: [TableColumn.TITLE_COMBINED],
                }),
                enableAlternateRowColors: false,
                enableHeader: true,
                enableHorizontalBorders: false,
